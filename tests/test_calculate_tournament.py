...
new_ratings = {1: 2540.51, 2: 2534.829, 3: 2384.343, 4: 2457.874, 5: 2111.09, 6: 2205.304,
               7: 2227.664, 8: 2237.561, 9: 1790.433, 10: 1758.159, 11: 1642.436, 12: 1835.701,
               13: 1612.438, 14: 1627.721, 15: 1617.362, 16: 1578.874, 17: 1535.657, 18: 1611.413,
               19: 1454.59, 20: 1335.011, 21: 1263.787, 22: 1070.278, 23: 1000.444, 24: 978.737,
               25: 950.91, 26: 874.615, 27: 795.968, 28: 817.877, 29: 714.28, 30: 708.801,
               31: 610.088, 32: 488.448, 33: 568.427, 34: 523.939, 35: 507.908, 36: 466.755,
               37: 366.921, 38: 313.823, 39: 357.755, 40: 327.369, 41: 2431.77, 42: 2393.86,
               43: 250.675, 44: 319.565, 45: 237.532, 46: 104.377, 47: 106.959, 48: 100}


def test_calculate_tournament():
    new_ratings = calculate_tournament(ratings, data)
    print({key: round(new_ratings[key], 3) for key in new_ratings})
    rounded_ratings = {key: round(new_ratings[key]) for key in new_ratings}
    assert rounded_ratings == expected_ratings


def test_print():
    for player in range(1, 49):

        for opponent, result in data[player]:
            if opponent:
                print(f"({player}, {opponent}, {result}),")
